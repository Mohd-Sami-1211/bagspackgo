            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-gray-600 flex items-center mt-1">
                  ...
                  <span className="text-sm">{guide.name || "Local Guide"}</span>
                </p>
              </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-medium capitalize">{event?.destination}</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {event?.totalSlots-event?.bookings} slots remaining
                  </p>
                </div>
              </div>
            </div>
           ...
           {activeTab === 'details' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-700 mb-6">{event?.about || "This exciting event offers a unique opportunity to experience the local culture and activities. Our expert guides will ensure you have a memorable time while learning about the area's history and traditions."}</p>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-700 mb-4">{event?.pickupPoints?.[0]?.location || "Main entrance of the city park, near the fountain. Look for our guide wearing the company t-shirt."}</p>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <p className="text-gray-700">Maximum of {event?.totalSlots || 12} participants to ensure a personalized experience.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-red-50 p-4 rounded-lg border border-red-100">
                    ...
                    <ul className="text-red-700 text-sm space-y-1">
                      {event?.restrictions?.map((item , index)=>(
                        <li key = {index} className="flex items-start">
