...
export const metadata = pageMetadata({ title: 'About Bagspackgo: A Kashmir-Based Travel Platform', description: 'Meet Bagspackgo, a Kashmir-based travel startup bringing trips, offbeat destinations, events and Companion assistance together.', path: '/about' });
export default function AboutPage() {
  return <article className="mx-auto max-w-5xl px-5 py-16 text-[#17372f] sm:px-8">
    ...
    <section className="mt-12 rounded-3xl bg-[#f8f6f0] p-8">
      <h2 className="font-serif text-3xl">More choice. More ways to travel.</h2>
      <p className="mt-5 max-w-3xl leading-8 text-slate-600">Bagspackgo is built around a simple idea: travelers should have more choice and flexibility, with local travel services easier to discover and compare.</p>
    </section>
    <section className="mt-12">
      ...
      <dl className="mt-6 grid gap-8 sm:grid-cols-2">
        {[
          ...
          ['Events', '/user/events', 'Local organizers and travel companies share scheduled travel activities you can discover and join.'],
    ...
    <section className="mt-12 border-t border-[#17372f]/15 pt-10"><h2 className="font-serif text-3xl">Make your next journey a Bagspackgo journey.</h2><p className="mt-5 leading-8 text-slate-600">Discover packages from local companies, request a personalized offbeat escape, join an available event or choose Companion for on-trip call assistance. Start with the way you want to travel.</p><Link href="/travel-guides" className="mt-6 inline-block font-bold underline underline-offset-4">Explore Bagspackgo →</Link></section>
  </article>;
}
