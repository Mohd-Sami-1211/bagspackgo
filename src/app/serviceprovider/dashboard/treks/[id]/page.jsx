...
/* ── page ── */
export default function SingleTrekBooking() {
    const { id } = useParams();
    ...
    const dropoff = booking.pickupDropoff?.dropoff || {};
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 pb-16">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <Link href="/serviceprovider/dashboard/treks"
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            { icon: Users, label: 'Trekkers', value: `${booking.numPeople} Person(s)` },
                    ...
                    <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm overflow-hidden">
                        <div className="px-5 py-4 border-b border-neutral-50 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-sm font-bold text-gray-700">Trekkers</h3>
                            </div>
                        ...
                        {travelers.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center gap-3 py-16 px-6 text-center">
                                ...
                                <p className="text-sm font-semibold text-neutral-500">No trekker details available</p>
