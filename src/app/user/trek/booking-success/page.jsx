                    ...
                    >
                        ...
                        <div className="bg-white rounded-3xl shadow-[0_15px_40px_rgb(0,0,0,0.06)] border border-gray-100 overflow-hidden mb-8">
                            ...
                            <div className="p-6 sm:p-8 border-b border-gray-100 relative">
                                ...
                                <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-6 relative z-10">Trek Summary</h3>
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 mb-6 relative z-10 flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
                                    <div>
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                                            <Mountain className="w-3 h-3"/> Trek Name
                                        </p>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1.5"><Users className="w-3 h-3"/> Trekkers</p>
                                        <p className="font-bold text-gray-900 text-sm leading-tight">{numPeople || 1} Pax</p>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="font-bold text-gray-900 text-sm leading-tight">{pickupDropoff?.pickup?.time || 'Pending'}</p>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    {travelers.length > 0 ? travelers.map((t, idx) => (
                                        <div key={idx} className="flex flex-col p-4 bg-white border border-gray-200 rounded-2xl shadow-sm">
                                            <p className="font-black text-gray-900 text-sm mb-1">{t.name || "Unnamed Trekker"}</p>
                                        ...
                                        <p className="text-sm font-medium text-gray-500 italic col-span-2">No specific trekker names recorded.</p>
                                    )}
                                </div>
                            </div>
