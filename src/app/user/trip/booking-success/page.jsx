...
function BookingSuccessContent() {
    ...
    const bookingRef = searchParams.get('ref') || 'BPG-' + Date.now().toString(36).toUpperCase();
                        ...
                        <div ref={printRef} className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                            ...
                            <div className="bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 p-10 text-center relative overflow-hidden">
                                ...
                                >
                                    ...
                                    <p className="text-green-100">Your adventure is officially locked in. Get ready to explore!</p>
                                </motion.div>
                            </div>
                                ...
                                {booking && (
                                    ...
                                    >
                                        {[
                                            ...
                                            { icon: Users, label: 'Travellers', value: `${booking.numPeople} ${booking.category === 'couple' ? 'couple' : 'person(s)'}` },
        ...
        <Suspense fallback={
            <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-green-700 font-medium">Loading your booking...</p>
                </div>
            </div>
        }>
