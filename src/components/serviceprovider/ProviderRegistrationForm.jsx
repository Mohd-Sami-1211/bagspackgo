        ...
        {STEPS.map((s, idx) => {
          ...
          return (
            <div key={s.id} className="flex items-center">
              ...
              {idx < STEPS.length - 1 && (
                <div className={`h-1 w-8 sm:w-16 mx-1 rounded-full ${completed ? s.color : 'bg-gray-200'} transition-all duration-500`} />
              )}
            </div>
          );
        })}
                ...
                {!submitted ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-xl font-medium flex items-center gap-2 shadow-lg hover:shadow-emerald-200 transition-all"
                    >
