            ...
            >
                ...
                {activeFeatured ? (
                    <div className="relative z-20 mx-auto flex min-h-[610px] max-w-7xl items-end px-4 pb-12 pt-44 sm:px-6 sm:pb-16 md:items-center md:pb-8 lg:min-h-[680px] lg:px-8">
                        <AnimatePresence mode="wait">
                            <motion.div key={`copy-${activeFeatured._id}`} initial={{ opacity: 0, x: -18 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 12 }} transition={{ duration: 0.45 }} className="max-w-xl">
                                ...
                                <h2 className="font-serif text-5xl leading-[0.94] tracking-[-0.045em] sm:text-6xl lg:text-7xl">{activeFeatured.title}</h2>
                    ...
                    <div className="relative z-20 mx-auto flex min-h-[610px] max-w-7xl items-end px-4 pb-20 pt-44 sm:px-6 md:items-center lg:min-h-[680px] lg:px-8">
                        <div className="max-w-xl"><p className="mb-3 text-[11px] font-bold uppercase tracking-[0.24em] text-[#d9bd86]">Offbeats</p><h2 className="font-serif text-5xl leading-[0.96] tracking-[-0.04em] sm:text-6xl">Find the places maps rarely mention.</h2><p className="mt-5 text-white/70">Select featured destinations from the admin dashboard to present them here.</p></div>
                    </div>
                )}
